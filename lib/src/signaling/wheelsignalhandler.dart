...
class WheelSignalHandler extends SignalHandler {
  ...
  WheelSignalHandler(DataSource ds) : super(ds) {
    registerHandler(PACKET_TYPE_CONNECTED, onConnect);
    registerHandler(PACKET_TYPE_DISCONNECTED, onUserDisconnect);
    registerHandler(PACKET_TYPE_ID, onIdExistingChannelUser);
    registerHandler(PACKET_TYPE_USERMESSAGE, onUserMessage);
  }
